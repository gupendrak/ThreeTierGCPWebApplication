...
def main_page_welcome():
    ...
    <html>
        <head>
            <title>Upendra ToDo Backend page</title>
        </head>
        <body>
            <h1>Hello. This is main page of Upendra's ToDo back-end</h1>
            <p>You can find sources in the <a href="https://github.com/gupendrak/">GitHub repo</a></p>
